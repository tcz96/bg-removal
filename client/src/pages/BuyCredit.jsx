    ...
    <div className='min-h-[70vh] text-center pt-14 mb-10'>
      ...
      <div className='flex flex-wrap justify-center gap-6 text-left'>
        {plans.map((item, index)=>(
          <div className='bg-white drop-shadow-sm border-none rounded-lg py-12 px-8 text-gray-700 hover:scale-105 transition-all duration-500' key={index}>
            ...
            <button className='w-full bg-gray-800 text-white mt-8 text-sm rounded-md py-2.5 min-w-35'>Purchase</button>
          </div>
        ))}
      </div>
    </div>
